...
export default function NotYetScreen() {
    ...
    const CSS = `
        ...
        .cta-btn-primary {
            ...
            background-size: 200% auto; color: ${isDark ? '#000' : '#e7d67aff'};
    ...
    return (
        <div style={S.container}>
            ...
            <div className="reveal" style={{ animationDelay: '0.05s' }}>
                <div style={S.badge}>
                    <Sparkles size={14} color={COLOR.gold} /> Page Not Yet Implemented
                </div>
            </div>

            <h1 className="reveal" style={{ ...S.h1, animationDelay: '0.1s' }}>
                Page Not Yet <span className="gold-text">Implemented</span>
            </h1>
