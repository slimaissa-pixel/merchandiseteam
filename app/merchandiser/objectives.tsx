...
export default function MerchandiserObjectives() {    
    ...
    const renderItem = ({ item }: { item: Objective }) => {
        ...
        const visitsPct = item.target_visits > 0 ? Math.min(item.current / item.target_visits, 1) : 0;
    ...
    return (
        <SafeAreaView style={[styles.container, { backgroundColor: colors.background }]}>
            <Header title="Objectives" subtitle="Track your goals" showBack />
